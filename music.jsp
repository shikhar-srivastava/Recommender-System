    ...
    <div class="row">
      <div class="col s8">
        <div class="row">
          <div class="section" id="index-banner">
            <div class="container">
              <br><h3 class="header center red-text">Music</h3>
              <div class="row center">
                <h5 class="light center-align">Enter the names of music that you like</h5>
              </div>
            </div>
          </div>
        </div>
        <div class="row">
          <div class="col s8 offset-s2">
            <form action="GetResults" id="content-form" method="post">
              ...
              <div class="row center">
                <div class="col s9">
                  <h5 class="blue-text center-align">Music Title</h5>
                </div>
                <div class="col s3">
              ...
              <input type="text" name="data_type" value="music" hidden/>
            </form>
      ...
      <div class="col s4">
        ...
        <form action="search" method="get">
          <p>If you are not sure about what the music title is search here</p>
